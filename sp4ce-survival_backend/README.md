...
Este servicio se ha diseñado usando [**PostgreSQL**](https://www.postgresql.org/) como base de datos relacional para el almacenamiento de los datos relacionados con los *usuarios* y usando [**Spring**](https://spring.io/) como *framework*.
...
Aplicando la actual última versión de la seguridad ofrecida por Spring, [Spring Security V6](https://docs.spring.io/spring-security/reference/index.html), el uso de **SSL** y los tokens personales (**JWT Auth0**), se garantiza una seguridad a la hora de guardar los datos de los distintos usuarios y en la conexión e integridad del servicio.
...
| PUT    | /me/password                               | JWT  | Actualizar la contraseña actual por parte de un usuario.		               		     | 200             | String         |
